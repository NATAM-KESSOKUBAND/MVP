...
| 항목 | 내용 |
|------|------|
| 전체 저작권 위험도 | {CR_OVERALL_EMOJI} {CR_OVERALL_LEVEL} — {CR_OVERALL_SCORE}% |
| 발견 항목 수 | {CR_TOTAL_ISSUES}건 |
| 🔴 HIGH | {CR_HIGH_COUNT}건 |
| 🟡 MEDIUM | {CR_MEDIUM_COUNT}건 |
| 분석 영상 길이 | {CR_VIDEO_DURATION} |
